            ...
            viewModel.salva(pagamento)
                .observe(this, Observer {
                    it?.dado?.let{
                        ...
                        val actionTelaPagamentoToListaProdutos =
                            PagamentoFragmentDirections.actionTelaPagamentoToListaProdutos()
                        navController.navigate(actionTelaPagamentoToListaProdutos)
                    }
                })
        }
    }
